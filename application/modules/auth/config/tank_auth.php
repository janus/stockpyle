...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'StockPyle';
$config['webmaster_email'] = 'tlhunter@stockpyle.net';
...
$config['recaptcha_public_key'] = '6Lcdur8SAAAAADMiD1Sy0q0Sh6xL4eH6ZTZg5uzS';
$config['recaptcha_private_key'] = '6Lcdur8SAAAAAGqGVyjp55jxI2Ml8KxlL_cNqRhQ';
