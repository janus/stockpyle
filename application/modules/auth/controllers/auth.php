...
class Auth extends CI_Controller {
	...
	function login() {
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$this->page_data = array_merge($data, $this->page_data);
			$this->load->view('page-top', $this->page_data);
			$this->load->view('auth/login_form', $this->page_data);
	...
	function register()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$this->page_data = array_merge($data, $this->page_data);
			$this->load->view('page-top', $this->page_data);
			$this->load->view('auth/register_form', $this->page_data);
			$this->load->view('page-bottom', $this->page_data);
		}
	}
